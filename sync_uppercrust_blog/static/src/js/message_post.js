odoo.define('sync_uppercrust_blog.thread', function(require) {
    'use strict';
    ...
    // load qweb template    
    ajax.loadXML('/sync_uppercrust_blog/static/src/xml/chatter_message.xml', qweb);
    ...
    var WebsiteMailThread = Widget.extend({
        ...
        prepend_message: function(message_data){            
            var msg = qweb.render('website.thread_message', message_data);            
