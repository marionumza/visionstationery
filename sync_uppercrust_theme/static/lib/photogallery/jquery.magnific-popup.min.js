		...
		var methods = {
			...
			init : function (options) {
				...
				return this.each(function(){
					...
					if (!plugindata) {
						...
						// load image data
						$this.gallerie('load', options['elem'] + "[data-toggle*=gallery]");
			...
			open : function(imageLink){
				return this.each(function(){
					...
					if ($overlay.is(':hidden')) {
						...
						// Customize From uppercrust[Add Comment]
			...
			close : function(){
				return this.each(function(){
					...
					// Customize From uppercrust
					$('body').find('#oe_main_menu_navbar').css('display','block')
