...
var GlobalSearch = Widget.extend({
    ...
    events: {
        'input input.global-search': function(e) {
            ...
            }else{if($('.user-dropdown.input-group').find('.cu_close').css('display')=='none'){
    ...
    start: function() {
        ...
        // self.autocomplete.$el.find('ul').on('scroll', function (e) {
        //     $(e.currentTarget).attr('style', 'overflow:auto');
        // })
    },
    });
