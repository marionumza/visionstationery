...
class IrWebTheme(models.Model):
    ...
    def set_customize_theme(self, theme_id, form_values):
        ...
        try:
            ...
            theme_path = path + "/uppercrust_backend_theme/static/src/less/variable.less"
            backend_login = path + "/backend_login/static/src/less/variable.less"
            status_tag = path + "/web_status_tags/static/src/less/variable.less"
        except Exception as e:
